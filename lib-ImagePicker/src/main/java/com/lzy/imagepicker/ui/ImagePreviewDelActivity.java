...
import com.lzy.imagepicker.util.DownLoadUtils;
...
public class ImagePreviewDelActivity extends ImagePreviewBaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra(ImagePicker.EXTRA_CAN_EDIT, true)) {
    ...
    @Override
    public void onImageLongSave(ImageItem imageItem) {
        // 弹窗保存图片
        TextView tvDes = findViewById(R.id.tv_des);
        DownLoadUtils.download(this, imageItem.path, tvDes);
    }
}