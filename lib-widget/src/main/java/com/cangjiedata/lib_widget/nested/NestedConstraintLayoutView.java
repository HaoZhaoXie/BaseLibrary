 ...
 */
public class NestedConstraintLayoutView extends ConstraintLayout implements NestedScrollingParent3,
        NestedScrollingChild3, ScrollingView {
    static final int ANIMATED_SCROLL_GAP = 250;

    static final float MAX_SCROLL_FACTOR = 0.5f;

    private boolean childScrollEnabled = false;

    private static final String TAG = "NestedConstraintLayoutView";
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(NestedConstraintLayoutView v, int scrollX, int scrollY,
    ...
    public NestedConstraintLayoutView(@NonNull Context context) {
        this(context, null);
    }

    public NestedConstraintLayoutView(@NonNull Context context, @Nullable AttributeSet attrs) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                */
                ...
                if (yDiff > mTouchSlop
                    ...
                    if(getChildCount() > 1){
                        mIsBeingDragged = !childScrollEnabled;
                    }else {
                        mIsBeingDragged = true;
                    }
//                    if(isChildScrollEnabled()){//子view获取滑动事件
//                        if(y - mLastMotionY > 0){//向下拉动
//                            if(getChildCount() > 0){
...
//                            }
//                        }else {//向上滑动
//                            mIsBeingDragged = getChildCount() == 1;
//                        }
//                    }else {//子view不可滑动
//                        mIsBeingDragged = true;
//                    }
                ...
                Log.e(TAG, "onInterceptTouchEvent: Move " + mIsBeingDragged  + " childScrollEnabled " + childScrollEnabled);
                break;
            }
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                */
                ...
                Log.e(TAG, "onInterceptTouchEvent: Down " + mIsBeingDragged);
                break;
            }
        ...
        * drag mode.
        */
        Log.e(TAG, "onInterceptTouchEvent: " + mIsBeingDragged);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.e(TAG, "onInterceptTouchEvent: onTouchEvent " + mIsBeingDragged + " childScrollEnabled " + childScrollEnabled);
                if (mIsBeingDragged) {
   ...
   /**
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final NestedConstraintLayoutView nsvHost = (NestedConstraintLayoutView) host;
    ...
    public boolean isChildScrollEnabled() {
        return childScrollEnabled;
    }

    public void setChildScrollEnabled(boolean childScrollEnabled) {
        this.childScrollEnabled = childScrollEnabled;
    }
}
