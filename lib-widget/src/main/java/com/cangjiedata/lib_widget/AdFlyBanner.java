...
/**
 * 广告
 * Created by recker on 16/9/30.
 */
public class AdFlyBanner extends RoundRelativeLayout {
    ...
    //指示点资源
    private int mPointDrawableResId = R.drawable.banner_point_sel;
    //指示容器背景
    ...
    public AdFlyBanner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AdFlyBanner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        final int index = a.getInt(R.styleable.FlyBanner_itemScaleType, -1);
        if (index >= 0) {
    ...
    private void setLayout(Context context) {
        ...
        //设置内边距
        pointContainerRl.setPadding(0, 10, 0, WidgetUtils.dip2px(getContext(),8));
        //设定指示器容器布局及位置
...
//        初始化ViewPager
     ...
     * @param urls
     */
//    public void setImagesUrl(List<BannerBean> urls) {
//        //加载网络图片
//        mIsImageUrl = true;
    ...
    private ViewPager.OnPageChangeListener mOnPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if(onPageChangeListener != null){
                onPageChangeListener.onPageSelected(toRealPosition(mCurrentPositon));
            }
        }
...
//            imageView.setPadding(WidgetUtils.dip2px(getContext(), 20), 0, WidgetUtils.dip2px(getContext(), 20), WidgetUtils.dip2px(getContext(), 20));
            ...
            if (mIsImageUrl) {
                Glide.with(getContext())
                        ...
                        .placeholder(R.mipmap.pic_loading_9)
                        .error(R.mipmap.pic_loading_9)
//                        .apply(RequestOptions.bitmapTransform(new RoundedCornersTransformation(WidgetUtils.dip2px(getContext(), 6), 0,
//                                RoundedCornersTransformation.CornerType.ALL)))
    ...
    private void switchToPoint(final int currentPoint) {
        for (int i = 0; i < mPointRealContainerLl.getChildCount(); i++) {
            if(mPointRealContainerLl.getChildAt(i).isEnabled()) {
        ...
        mPointRealContainerLl.getChildAt(currentPoint).requestLayout();
    }
