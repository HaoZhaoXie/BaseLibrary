...
/**
 * @ClassName: PasswordKeyboardView
 * @Description:
 * @Author: 星河
 * @Date: 2021/3/15 19:04
 */
public class PasswordKeyboardView extends KeyboardView implements KeyboardView.OnKeyboardActionListener {
    ...
    private int delKeyBackgroundColor = 0xffededed;
...
//            }
            if (key.codes[0] == Keyboard.KEYCODE_DELETE) {
                drawKeyBackground(key, canvas, delKeyBackgroundColor);
                drawKeyIcon(key, canvas, getResources().getDrawable(R.mipmap.icon_pay_delete));
            }
        }
