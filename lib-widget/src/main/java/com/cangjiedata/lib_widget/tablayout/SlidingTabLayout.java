package com.cangjiedata.lib_widget.tablayout;
...
import com.cangjiedata.lib_widget.tablayout.listener.OnTabSelectListener;
import com.cangjiedata.lib_widget.tablayout.utils.UnreadMsgUtils;
import com.cangjiedata.lib_widget.tablayout.widget.MsgView;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private int mTabTextViewWidth;
    private int mTabTextViewHeight;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTabTextViewBackground = ta.getResourceId(R.styleable.SlidingTabLayout_tl_tabTextView_background, -1);
        mTabTextViewWidth = ta.getResourceId(R.styleable.SlidingTabLayout_tl_tabTextView_width, -1);
        mTabTextViewHeight = ta.getResourceId(R.styleable.SlidingTabLayout_tl_tabTextView_height, -1);
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                if(mTabTextViewBackground != -1){
                    tv_tab_title.setBackgroundResource(mTabTextViewBackground);
                }
                if(mTabTextViewWidth != -1){
                    tv_tab_title.setMinWidth(getResources().getDimensionPixelSize(mTabTextViewWidth));
                }
                if(mTabTextViewHeight != -1){
                    tv_tab_title.setMinHeight(getResources().getDimensionPixelSize(mTabTextViewHeight));
                }
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setActivated(isSelect);
    ...
    public void setCloseClick(boolean closeClick) {
        this.mCloseClick = mCloseClick;
    }
