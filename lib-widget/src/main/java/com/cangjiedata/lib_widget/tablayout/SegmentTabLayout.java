...
import com.cangjiedata.lib_widget.tablayout.utils.FragmentChangeManager;
...
public class SegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTabTextViewBackground = ta.getResourceId(R.styleable.SegmentTabLayout_tl_tabTextView_background, -1);
        mTabTextViewWidth = ta.getResourceId(R.styleable.SegmentTabLayout_tl_tabTextView_width, -1);
        mTabTextViewHeight = ta.getResourceId(R.styleable.SegmentTabLayout_tl_tabTextView_height, -1);
