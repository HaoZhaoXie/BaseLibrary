...
public class DateTimePicker implements View.OnClickListener, PickerView.OnSelectListener {
     ...
     */
    public DateTimePicker(Context context, CustomDatePicker.Callback callback, String beginDateStr, String endDateStr) {
     ...
     */
    public DateTimePicker(Context context, CustomDatePicker.Callback callback, long beginTimestamp, long endTimestamp) {
    ...
    private void setCanScroll() {
        ...
        mDpvHour.setCanScroll(mHourUnits.size() > 1);
        mDpvMinute.setCanScroll(mMinuteUnits.size() > 1);
    }
