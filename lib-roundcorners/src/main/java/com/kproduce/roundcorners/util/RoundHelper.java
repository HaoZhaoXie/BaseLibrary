...
public class RoundHelper {
    ...
    public void preDraw(Canvas canvas) {
        ...
        if (mStrokeWidth > 0) {
            float sx = (mWidth - 2 * mStrokeWidth + DensityUtil.dip2px(mView.getContext(), 1f)) / mWidth;
            float sy = (mHeight - 2 * mStrokeWidth + DensityUtil.dip2px(mView.getContext(), 1f)) / mHeight;
