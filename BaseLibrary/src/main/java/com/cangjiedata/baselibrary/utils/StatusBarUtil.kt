...
import com.cangjiedata.baselibrary.utils.OSUtils.isFlyme
import com.cangjiedata.baselibrary.utils.OSUtils.isMiui
...
class StatusBarUtil {
    ...
    private fun setStatusBarVisible(activity: Activity, show: Boolean) {
        if (show) {
    ...
    companion object {
        ...
        fun getWebViewStatusBarHeight(context: Context): Int {
            //低版本 直接设置0
