package com.cangjiedata.share.lib;
...
public class ShareConstant {
    ...
    public static final int THUMB_WIDTH_SIZE = (int) (210 * 2);//微信小logo大小
    public static final int THUMB_HEIGHT_SIZE = (int) (168 * 2);//微信小logo大小
